...
export default function LeadsPage() {
    ...
    const { data: leadsData, loading: leadsLoading } = useCollection(collection(firestore, 'leads'));
    const { data: staffData, loading: staffLoading } = useCollection(collection(firestore, 'staff'));
