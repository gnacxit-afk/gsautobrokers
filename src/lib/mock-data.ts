...
const leads: Lead[] = [
  ...
  { id: '4', name: 'Patricia Garcia', email: 'pat.g@example.com', phone: '456-789-0123', company: 'Global Exports', status: 'On site', notes: 'Evaluating our proposal against a competitor. Follow up on Friday.', ownerId: '3', ownerName: 'Olivia Brown', channel: 'Visit', createdAt: '2024-04-28T14:00:00Z' },
  { id: '5', name: 'Michael Brown', email: 'mike.b@example.com', phone: '567-890-1234', company: 'HealthFirst', status: 'Sale', notes: 'Sale closed for a Toyota Camry. Happy customer.', ownerId: '4', ownerName: 'Noah Williams', channel: 'Facebook', createdAt: '2024-04-20T16:00:00Z' },
