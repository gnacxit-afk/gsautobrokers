...
let leads: Lead[] = [
  { id: '1', name: 'John Doe', phone: '123-456-7890', status: 'New', notes: 'Interested in a reliable family SUV. Mentioned the new Highlander model.', ownerId: '33333333-3', ownerName: 'Olivia Brown', channel: 'Facebook', createdAt: '2024-05-01T10:00:00Z', language: 'English' },
  { id: '2', name: 'Jane Smith', phone: '234-567-8901', status: 'Contacted', notes: 'Looking for a luxury sedan, budget around $50k. Booked a test drive for the Lexus ES.', ownerId: '44444444-4', ownerName: 'Noah Williams', channel: 'WhatsApp', createdAt: '2024-05-03T11:00:00Z', language: 'English' },
  { id: '3', name: 'Sam Wilson', phone: '345-678-9012', status: 'Qualified', notes: 'Needs a fleet of 5 mid-size sedans for corporate use. Sent initial proposal.', ownerId: '22222222-2', ownerName: 'Liam Smith', channel: 'Call', createdAt: '2024-05-05T09:30:00Z', language: 'English' },
  { id: '4', name: 'Patricia Garcia', phone: '456-789-0123', status: 'On site', notes: 'Evaluating our proposal against a competitor. Follow up on Friday.', ownerId: '33333333-3', ownerName: 'Olivia Brown', channel: 'Visit', createdAt: '2024-04-28T14:00:00Z', language: 'Spanish' },
  { id: '5', name: 'Michael Brown', phone: '567-890-1234', status: 'Sale', notes: 'Sale closed for a Toyota Camry. Happy customer.', ownerId: '44444444-4', ownerName: 'Noah Williams', channel: 'Facebook', createdAt: '2024-04-20T16:00:00Z', language: 'English' },
  { id: '6', name: 'Linda Davis', phone: '678-901-2345', status: 'Lost', notes: 'Chose a competitor due to pricing. Sent a thank-you note.', ownerId: '55555555-5', ownerName: 'Emma Jones', channel: 'Other', createdAt: '2024-04-15T12:00:00Z', language: 'English' },
  { id: '7', name: 'James Johnson', phone: '789-012-3456', status: 'Closed', notes: 'Repeat customer, looking to trade in his old car for a new truck.', ownerId: '55555555-5', ownerName: 'Emma Jones', channel: 'Call', createdAt: '2024-05-10T10:00:00Z', language: 'English' },
  { id: '8', name: 'Barbara Miller', phone: '890-123-4567', status: 'Contacted', notes: 'Wants an electric vehicle. Discussed the Mustang Mach-E.', ownerId: '33333333-3', ownerName: 'Olivia Brown', channel: 'Visit', createdAt: '2024-05-12T15:00:00Z', language: 'English' },
];
