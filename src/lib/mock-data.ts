...
let leads: Lead[] = [
  { id: '1', name: 'John Doe', email: 'john.d@example.com', phone: '123-456-7890', company: 'Innovate Inc.', status: 'New', notes: 'Interested in a reliable family SUV. Mentioned the new Highlander model.', ownerId: '33333333-3', ownerName: 'Olivia Brown', channel: 'Facebook', createdAt: '2024-05-01T10:00:00Z' },
  { id: '2', name: 'Jane Smith', email: 'jane.s@example.com', phone: '234-567-8901', company: 'Solutions Co.', status: 'Contacted', notes: 'Looking for a luxury sedan, budget around $50k. Booked a test drive for the Lexus ES.', ownerId: '44444444-4', ownerName: 'Noah Williams', channel: 'WhatsApp', createdAt: '2024-05-03T11:00:00Z' },
  { id: '3', name: 'Sam Wilson', email: 'sam.w@example.com', phone: '345-678-9012', company: 'Tech Forward', status: 'Qualified', notes: 'Needs a fleet of 5 mid-size sedans for corporate use. Sent initial proposal.', ownerId: '22222222-2', ownerName: 'Liam Smith', channel: 'Call', createdAt: '2024-05-05T09:30:00Z' },
  { id: '4', name: 'Patricia Garcia', email: 'pat.g@example.com', phone: '456-789-0123', company: 'Global Exports', status: 'On site', notes: 'Evaluating our proposal against a competitor. Follow up on Friday.', ownerId: '33333333-3', ownerName: 'Olivia Brown', channel: 'Visit', createdAt: '2024-04-28T14:00:00Z' },
  { id: '5', name: 'Michael Brown', email: 'mike.b@example.com', phone: '567-890-1234', company: 'HealthFirst', status: 'Sale', notes: 'Sale closed for a Toyota Camry. Happy customer.', ownerId: '44444444-4', ownerName: 'Noah Williams', channel: 'Facebook', createdAt: '2024-04-20T16:00:00Z' },
  { id: '6', name: 'Linda Davis', email: 'linda.d@example.com', phone: '678-901-2345', company: 'BuildRight', status: 'Lost', notes: 'Chose a competitor due to pricing. Sent a thank-you note.', ownerId: '55555555-5', ownerName: 'Emma Jones', channel: 'Other', createdAt: '2024-04-15T12:00:00Z' },
  { id: '7', name: 'James Johnson', email: 'james.j@example.com', phone: '789-012-3456', company: 'Innovate Inc.', status: 'Closed', notes: 'Repeat customer, looking to trade in his old car for a new truck.', ownerId: '55555555-5', ownerName: 'Emma Jones', channel: 'Call', createdAt: '2024-05-10T10:00:00Z' },
  { id: '8', name: 'Barbara Miller', email: 'barb.m@example.com', phone: '890-123-4567', company: 'MarketFresh', status: 'Contacted', notes: 'Wants an electric vehicle. Discussed the Mustang Mach-E.', ownerId: '33333333-3', ownerName: 'Olivia Brown', channel: 'Visit', createdAt: '2024-05-12T15:00:00Z' },
];
